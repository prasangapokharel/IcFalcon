---
name: IcFalcon-productionDeployStandard
description: >-
...
Detail docs: [`motoko/deployGuide/`](../../motoko/deployGuide/)
...
- [ ] Stable shape changes wired — [`migration/SKILL.md`](../../migration/SKILL.md)
...
Detail: [`motoko/deployGuide/mainnet-fresh.md`](../../motoko/deployGuide/mainnet-fresh.md)
...
Detail: [`motoko/deployGuide/mainnet-upgrade.md`](../../motoko/deployGuide/mainnet-upgrade.md)
...
Env wiring: [`motoko/deployGuide/frontend-connection.md`](../../motoko/deployGuide/frontend-connection.md)
...
| Deploy reference | [`motoko/deployGuide/SKILL.md`](../../motoko/deployGuide/SKILL.md) |
