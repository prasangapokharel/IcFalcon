...
**IcFalcon project coding standard** (naming, file size, layering imports):
...
| Topic | File |
|---|---|
| Reserved keywords | [`references/reserved-keywords.md`](references/reserved-keywords.md) |
| Type conversions | [`references/type-conversions.md`](references/type-conversions.md) |
| Control flow (`??`, `do ?`) | [`references/control-flow.md`](references/control-flow.md) |
| Equality / compare | [`references/equality.md`](references/equality.md) |
| Compiler flags | [`references/project-setup.md`](references/project-setup.md) |
...
**For actor upgrades/migrations:** load `migratingMotokoStandard` for inline migration or `migratingMotokoEnhancedStandard` for multi-migration with `--enhanced-migration`. Under `--enhanced-migration`, actor fields **cannot** have initializers — declare them as `var x : T;` and set initial values in the migration that introduces them. The actor examples in this skill use initializers and would need adjustment for enhanced-migration projects.
...
| `Compatibility error [M0170]`                          | Load `migratingMotokoEnhancedStandard`            |
...
- **Reserved keywords**: [references/reserved-keywords.md](references/reserved-keywords.md)
- **Type conversions**: [references/type-conversions.md](references/type-conversions.md)
- **Control flow**: [references/control-flow.md](references/control-flow.md)
- **Equality**: [references/equality.md](references/equality.md)
- **Compiler flags**: [references/project-setup.md](references/project-setup.md)
