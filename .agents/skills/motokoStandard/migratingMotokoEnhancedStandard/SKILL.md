---
name: migratingMotokoEnhancedStandard
description: >-
...
- Load `writingMotokoStandard` for general Motoko language reference and mo:core APIs
- Load `migratingMotokoStandard` for inline migration without `--enhanced-migration`
