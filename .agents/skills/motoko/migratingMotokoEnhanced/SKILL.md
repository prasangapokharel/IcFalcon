...
- Load `writingMotoko` for general Motoko language reference and mo:core APIs
- Load `migratingMotoko` for inline migration without `--enhanced-migration`
