...
|---|---|---|
| `dfx build` fails on migration | Record shape changed without migration | [`../../migration/SKILL.md`](../../migration/SKILL.md) |
...
- [`../writingMotoko/SKILL.md`](../writingMotoko/SKILL.md)
