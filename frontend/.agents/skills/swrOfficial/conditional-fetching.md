---
name: swr-conditional-fetching
description: SWR conditional and dependent data fetching — null or function keys to pause requests, and serial dependent fetches. Use when writing useSWR that depends on user state or other data.
